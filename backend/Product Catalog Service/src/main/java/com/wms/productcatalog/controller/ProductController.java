...
public class ProductController {
     ...
     */
    @Operation(summary = "Update an existing product", description = "Updates all fields of an existing product by its ID. All required fields must be provided.")
    @ApiResponses(value = {
    ...
    public ResponseEntity<ProductDTO> activateProduct(
            @Parameter(description = "ID of the product to activate", required = true) @PathVariable Long id) {
    ...
    public ResponseEntity<ProductDTO> deactivateProduct(
            @Parameter(description = "ID of the product to deactivate", required = true) @PathVariable Long id) {
